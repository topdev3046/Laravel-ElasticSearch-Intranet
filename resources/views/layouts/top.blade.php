...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <div class="navbar-header col-xs-12 col-md-9">
        ...
        <div class="col-xs-12 col-md-3 nopadding-left">
            
            <!--<button type="button" class="btn btn-sm btn-default navbar-toggle-big pull-left" title="Menü Ein-/Ausblenden">-->
    ...
    <div class="navbar-header col-xs-12 col-md-3">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                <li><a href="#"><i class="fa fa-user fa-fw"></i> Mein Profil</a> 
                </li>
                <li><a href="#"><i class="fa fa-gear fa-fw"></i> Einstellungen</a>
                </li>
                <li class="divider"></li>
                <li><a href="{{ url('logout') }}"><i class="fa fa-sign-out fa-fw"></i> Ausloggen</a>
                </li>
            </ul>
            <!-- /.dropdown-user -->
        </li>
